...
def run(args: DictConfig):
    ...
    #     Optimizer
    # ------------------
    optimizer = torch.optim.Adam(model.parameters(), lr=args.lr, weight_decay=1e-5)  # weight_decayを追加
    ...
    for epoch in range(args.epochs):
        ...
        for X, y, subject_idxs in tqdm(train_loader, desc="Train"):
            ...
            y_pred = model(X, subject_idxs)  # subject_idxsを追加
    ...
    for X, subject_idxs in tqdm(test_loader, desc="Validation"):
        ...
        preds.append(model(X, subject_idxs).detach().cpu())  # subject_idxsを追加
